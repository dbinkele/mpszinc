...
public class Model_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    for (SNode stat : ListSequence.fromList(SLinkOperations.getChildren(ctx.getPrimaryInput(), LINKS.Stats$mE0D)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !(Objects.equals(SNodeOperations.getConcept(it), CONCEPTS.EmptyStatement$9Y));
      }
    })) {
      tgs.appendNode(stat);
      tgs.append(";");
